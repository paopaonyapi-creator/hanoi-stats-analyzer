    ...
    <div className="animate-slide-up">
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
        ...
        <div className="glass-card p-5 border-l-4 border-l-[var(--accent-emerald)] flex flex-col justify-between">
          <div className="flex justify-between items-start">
            <div>
              <div className="text-[10px] font-black text-[var(--text-muted)] uppercase tracking-widest mb-1">Dataset Size</div>
              <div className="text-3xl font-black text-white">{summary.totalRecords.toLocaleString()}</div>
            </div>
            ...
            <tbody>
              {summary.recentRecords.slice(0, 10).map((r) => (
                <tr key={r.id} className="border-b border-[rgba(255,255,255,0.03)] hover:bg-[rgba(255,255,255,0.02)] transition-colors">
                  <td className="py-4">
                    <span className={`text-[10px] font-black px-2 py-0.5 rounded-full ${r.drawType === 'NORMAL' ? 'bg-[var(--accent-blue)] text-white' :
          ...
          {summary.recentRecords.slice(0, 8).map((r) => (
            ...
            >
              <div className="mb-3 flex items-start justify-between gap-3">
                <span className={`rounded-full px-2 py-1 text-[10px] font-black ${r.drawType === "NORMAL"
